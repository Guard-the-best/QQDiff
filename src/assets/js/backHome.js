...
export default {
  ...
  //echartsTest
  echartsMoney: function (id, data, title) {
  ...
  //订单总量
  echartsOrderNum: function (id, data, title) {
    // 基于准备好的dom，初始化echarts实例
    var myChart = echarts.init(document.getElementById(id));
      ...
      tooltip: {
        ...
        formatter: function (val) {
          ...
          if (val.componentSubType == "lines") {
            ...
            //点击城市，刷新一圈的数据
            if (tag == 1) {
              this.mapDataAjax(val.data.name);
            }
